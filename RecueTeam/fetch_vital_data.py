...
with open('victim_json_template_flat.json', 'r') as f:
    victim_template = json.load(f)


# # Send the data and get the generated key
# generated_key = send_victim_data(victim_template)

# # Now you can use the generated_key to update the data
# update_(generated_key, {'emergency_status': 'high_priority', 'last_updated': time, 'latitude': 37.7749, 'longitude': -122.4194})