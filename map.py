...
rescue = pd.read_csv('sf_rescue_dep.csv')
synth_data = pd.read_csv('health_check_descriptions.csv')
...
if my_dataset is not None :
    ...
    with open('rescue_conf.kgl', 'r') as f:
        base_config = json.load(f)

    with open('victims_config.kgl', 'r') as f:
